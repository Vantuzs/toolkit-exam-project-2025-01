export const Content = [
    {
        ...
        answer: 'For Naming contests, you will start receiving your submissions within few minutes of launching your contest...'
    },{
...
export const buyingFromMarketplaceContent = [
    {
...
export const managedContestsContent = [
    {
    ...
    },
    {
        ...
        answer: (
            ...
            <ul>
                    <li>① a $500 award amount (instead of $300), which will attract our top Creatives and provide more options to choose from; </li>
                    <li>② we will ensure a senior member of our branding team is assigned to your project and the branding team will invest about 3X more time in the day-to-day management of your project;</li>
                    <li>③ you will receive more high-end trademark report and 5X more responses for your audience test. </li>
                    <li>Here is a link to our <a href="https://www.atom.com/views/contests/create/managed_contests.php">Pricing page</a> with a detailed comparison of the two packages.</li>
                  </ul>
            </>
        )
    },
...
export const creativesContent = [
    {
        question: 'Can anyone join your platform?',
        answer: (
            <>
            We are open to anyone to signup. However, we have an extensive '<a href="#">Quality Scoring</a>' 
