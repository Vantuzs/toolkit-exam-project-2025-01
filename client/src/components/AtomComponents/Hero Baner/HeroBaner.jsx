...
const HeroBaner = () => {
    return (
        <section className={`${styles['home-hero']} ${styles['atp-hero']}`}>
            <div className={styles['hh-inner']}>
                <div className={styles['hh-content']}>
                    <div className={styles['container']}>
                        <div className={styles['atp-flex']}>
                            <div className={styles.left}>
                                <h4>World's #1 Naming Platform</h4>
                                <h1>How Does Atom Work?</h1>
                                <p>
                                    Atom helps you come up with a great name for your business by combining the power of 
                                    crowdsourcing with sophisticated technology and Agency-level validation services.
                                </p>
                            </div>
                            <div className={styles.right}>
                                <div className={styles['video-box-how-it-work']}>
                                    <iframe 
